            ...
            <style>
                ...
                *,
                ...
                .shadow-\[0px_14px_34px_0px_rgba\(0\,0\,0\,0\.08\)\] {
                    ...
                    --tw-shadow-colored: 0px 14px 34px 0px
                        var(--tw-shadow-color);
                ...
                .ring-gray-300 {
                    --tw-ring-opacity: 1;
                    --tw-ring-color: rgb(
                        209 213 219 / var(--tw-ring-opacity, 1)
                    );
                }
                .ring-transparent {
                ...
                .ring-white {
                    --tw-ring-opacity: 1;
                    --tw-ring-color: rgb(
                        255 255 255 / var(--tw-ring-opacity, 1)
                    );
                }
                .ring-white\/\[0\.05\] {
                ...
                .focus\:border-blue-300:focus {
                    --tw-border-opacity: 1;
                    border-color: rgb(
                        147 197 253 / var(--tw-border-opacity, 1)
                    );
                }
                ...
                .active\:bg-gray-100:active {
                    --tw-bg-opacity: 1;
                    background-color: rgb(
                        243 244 246 / var(--tw-bg-opacity, 1)
                    );
                }
                ...
                @media (prefers-color-scheme: dark) {
                    ...
                    .dark\:border-gray-600 {
                        --tw-border-opacity: 1;
                        border-color: rgb(
                            75 85 99 / var(--tw-border-opacity, 1)
                        );
                    }
                    .dark\:bg-black {
                        --tw-bg-opacity: 1;
                    ...
                    .dark\:ring-zinc-800 {
                        --tw-ring-opacity: 1;
                        --tw-ring-color: rgb(
                            39 39 42 / var(--tw-ring-opacity, 1)
                        );
                    }
                    ...
                    .dark\:hover\:ring-zinc-700:hover {
                        --tw-ring-opacity: 1;
                        --tw-ring-color: rgb(
                            63 63 70 / var(--tw-ring-opacity, 1)
                        );
                    }
                    .dark\:focus\:border-blue-700:focus {
                        --tw-border-opacity: 1;
                        border-color: rgb(
                            29 78 216 / var(--tw-border-opacity, 1)
                        );
                    }
                    .dark\:focus\:border-blue-800:focus {
                        --tw-border-opacity: 1;
                        border-color: rgb(
                            30 64 175 / var(--tw-border-opacity, 1)
                        );
                    }
                    .dark\:focus-visible\:ring-\[\#FF2D20\]:focus-visible {
                        --tw-ring-opacity: 1;
                        --tw-ring-color: rgb(
                            255 45 32 / var(--tw-ring-opacity, 1)
                        );
                    }
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <div
                                        class="from-transparent dark:via-zinc-900 dark:to-zinc-900 absolute -bottom-16 -left-16 h-40 w-[calc(100%_+_8rem)] bg-gradient-to-b via-white to-white"
                                    ></div>
                                </div>
